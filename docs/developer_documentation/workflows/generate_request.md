...
# [generate_request.yml](https://github.com/UKNCSP/CDDS-simulation-metadata/blob/main/.github/workflows/generate_request.yml)

## Overview

This workflow is triggered when a user fills out the [Request The Generation of A CDDS Request File](https://github.com/UKNCSP/CDDS-simulation-metadata/blob/main/.github/ISSUE_TEMPLATE/generate_request_file.yml) issue form. The workflow triggers the script [generate_request.py](https://github.com/UKNCSP/CDDS-simulation-metadata/blob/main/scripts/generate_request.py) which formats a ready to go Met Office or JASMIN request based off of the form content. This is then automatically commited and pushed to the [requests directory](https://github.com/UKNCSP/CDDS-simulation-metadata/tree/main/variables) with a filename formatted as `<request_type>_<model_workflow_id>_<package>.cfg`.
...
1. Delete the existing request and have the user re fill out the [Request The Generation of A CDDS Request File](https://github.com/UKNCSP/CDDS-simulation-metadata/blob/main/.github/ISSUE_TEMPLATE/generate_request_file.yml) issue form with the correct streams/package etc...
