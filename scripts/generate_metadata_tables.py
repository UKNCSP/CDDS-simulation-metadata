...
def get_mappings() -> list[str]:
    ...
    Read all of the mappings for a given model and return them as a list of lists.
        ...
        :returns: Table data as a list of lists, where the sublists contain data matching the HEADINGS fields.
    """
...
def build_table(table_data: list) -> str:
    """
...
def generate_html(table: str) -> None:
    """
